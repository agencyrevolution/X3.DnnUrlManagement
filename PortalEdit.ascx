...
<div class="DnnUrlManagement dnnForm">
    ...
    <div id="Basic" class="dnnClear">
        ...
        <div class="dnnFormItem">
            ...
            <asp:RadioButtonList runat="server" ID="rblDeletedTabHandlingType">
                <asp:ListItem Value="0" Text="301 Redirect to Site Home Page" />
                <asp:ListItem Value="1" Text="Show 404 Error" />
            </asp:RadioButtonList>
        </div>
    ...
    <div id="Pages" class="dnnClear">
        ...
        <div>
            ...
            <div class="dnnClear">
                <telerik:RadGrid ID="gvCustomUrls" runat="server" AutoGenerateColumns="False" Skin="Metro"
